...
//var global_funs = require('../../../global_funs');
var global_funs = require('../../../lib/global_funs.js');

function getPreData(req, callback) {
        ...
        fs.readdir(me.directory, function (err, list) {
            list.forEach(function (file) {
                ...
                for (var key in controller) {
                    ...
                    module.exports.debug && console.log(params);
            ...
            if (preFunName == '') {
                ...
                async.auto({
                    ...
                    fireRealAction: ['getPreData', function (callback, results) {
                        ...
                        module.exports.debug && console.log(preData);
                        ...
                        req.preData = preData;
                        f.apply(null, [req, res, module.exports.preFun].concat(pars));
                    }]
                });
            }
        });
